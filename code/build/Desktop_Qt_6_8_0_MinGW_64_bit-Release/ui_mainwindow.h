...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        nIpt = new QLineEdit(centralwidget);
        ...
        ok1 = new QPushButton(centralwidget);
        ...
        place1 = new QLineEdit(centralwidget);
        ...
        place2 = new QLineEdit(centralwidget);
        ...
        ok2 = new QPushButton(centralwidget);
        ...
        ipt_from_file = new QPushButton(centralwidget);
        ipt_from_file->setObjectName("ipt_from_file");

        verticalLayout_8->addWidget(ipt_from_file);

        ok3 = new QPushButton(centralwidget);
        ...
        clr_btn = new QPushButton(centralwidget);
        ...
        menubar->setGeometry(QRect(0, 0, 371, 17));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        ipt_from_file->setText(QCoreApplication::translate("MainWindow", "\344\273\216\346\226\207\344\273\266\345\275\225\345\205\245", nullptr));
